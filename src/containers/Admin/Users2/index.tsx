...
import { fetchUsers, fetchUser, addUser, editUser, deleteUser, resetEditData } from "../../../store/Users/actions";
            ...
            <div className="users container">
                ...
                <div className={chatClass + " block"}>
                    <div className={contactsClass}>
                        <Search />
                        <div onClick={openContacts ? this.onOpenContacts : null} className="chat__contacts">
                    ...
                    <div className="chat__dialog">
                        ...
                        <Scrollbar className="scroll chat__scroll" alwaysShowTracks>
                            <div className="p-4">
                                {!_.isEmpty(editUserData) && !showEditForm && <UserDetails data={editUserData} />}
